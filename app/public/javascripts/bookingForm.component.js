class BookingForm extends HTMLElement {
    ...
    //     document.getElementById('confirm-vehicle-model').textContent = 'Vehicle Model Here'; //to change (check with tomas)
    //     document.getElementById('confirm-vehicle-year').textContent = 'Vehicle Year Here';  //to change (check with tomas)
    ...
    // }
    // document.getElementById('confirm-pickup-location').textContent = 'Pickup Location Here'; // to change (check with tomas)
